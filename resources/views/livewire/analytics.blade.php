<div class="-mt-6">
    <header class="flex items-center justify-between px-4 pt-6 pb-20 bg-gray-100 lg:px-16">
        <div class="flex items-center animate__animated animate__pulse animate__infinite">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                class="text-blue-600 bi bi-dot" viewBox="0 0 16 16">
        ...
        <div class="flex items-center mr-6 md:mr-20 lg:mr-20">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                class="text-red-500 bi bi-youtube" viewBox="0 0 16 16">
                <path
    ...
    <div class="flex flex-col items-center justify-center -mt-12">
        <div class="flex flex-col items-center justify-center">
            <img src="https://yt3.ggpht.com/ytc/AAUvwnhQStkaJSFrZmeqrKRU5cgY4cnVTtPFg4iCRC3q=s900-c-k-c0x00ffffff-no-rj"
